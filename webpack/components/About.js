  ...
  <div>
    ...
    <br />
      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-md-3">
          <div className="thumbnail">
            <img className="profile-pic" src="https://s3-us-west-2.amazonaws.com/capstoneao-dev/Arlex_about.jpg" alt="..." />
            <div className="caption">
              <h3>Alex Quan</h3>
        ...
        <div className="col-sm-6 col-md-3">
          <div className="thumbnail">
            <img className="profile-pic" src="https://s3-us-west-2.amazonaws.com/capstoneao-dev/Justin_about.jpg" alt="..." />
            <div className="caption">
