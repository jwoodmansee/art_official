      ...
      <div className="col-sm-6 col-md-3">
        <div className="thumbnail">
          ...
          <div className="caption">
            <h3>Annie Hall</h3>
            <p>Annie Hall - AKA Annie Tha Danga, has been referred to as "..the hottest up and coming rapper from the streets of St. George, showing the world the real struggles of SG life", and "the most dangerous influence on our youth since The Simpsons..". She puts the G in design, and gave us the edge and street credit needed to standout in this digital market.</p>
            <p><a href="#" className="btn btn-primary" role="button">Facebook</a> <a href="#" className="btn btn-default" role="button">GitHub</a></p>
          </div>
        </div>
      </div>
    </div>
